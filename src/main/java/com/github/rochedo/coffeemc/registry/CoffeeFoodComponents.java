...
public class CoffeeFoodComponents {
    // Coffees Quality
    private static final FoodComponent.Builder POOR_COFFEE_CUP_BUILDER = new FoodComponent.Builder().hunger(5).saturationModifier(0.5F);
    public static final FoodComponent POOR_COFFEE_CUP = POOR_COFFEE_CUP_BUILDER.build();

    private static final FoodComponent.Builder GOOD_COFFEE_CUP_BUILDER = new FoodComponent.Builder().hunger(5).saturationModifier(0.5F);
    public static final FoodComponent GOOD_COFFEE_CUP = GOOD_COFFEE_CUP_BUILDER.build();

    private static final FoodComponent.Builder GREAT_COFFEE_CUP_BUILDER = new FoodComponent.Builder().hunger(5).saturationModifier(0.5F);
