...
public class CoffeeMachineGUI extends SyncedGuiDescription {

    public CoffeeMachineGUI(ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
